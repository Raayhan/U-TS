...
<body>
    ...
    <!-- Header End -->
    <h2 class="text-center pt-3">All Available Tuitions</h2><br>
    ...
    <div class="container-department">
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<h3 class="text-center text-blue">' . $row['teacher_name'] . '</h3>';
                echo '<hr>';
                echo '<h4 class="text-center text-red">' . $row['course_name'] . '</h4>';
                echo '<hr>';
                echo '<div class="row">';
                echo ' <div class="column">';
                echo '<hr>';
                echo '<h5>NSU ID : ' . $row['nsu_id'] . '</h5>';
                echo '<hr>';
                echo '<h5>Department: ' . $row['department'] . '</h5>';
                echo '<hr>';
                echo '</div>';
                echo '<div class="column">';
                echo ' <hr>';
                ...
                echo                     '<input type="hidden" name="student_name" value="' . $_SESSION['student']['name'] . '">';
            ...
            echo '<h6 class="alert-message-danger text-center">No Tuitions Available</h6>';
        }
        ?>

...
<head>
    ...
    <title><?php echo $_SESSION['student']['name']; ?> | UTS</title>
</head>
...
<body>
    ...
    <!-- Header End -->
    <h4 class="text-center pt-3">Student Profile</h4>
    <br>
    ...
    <div class="profile-container">
        ...
        <div id="Profile" class="row tabcontent">
            <div class="column">
                <img class="student_img" src="../img/student.png" alt="">
            </div>
            <div class="column profile">
                ...
                if ($result = $conn->query($query)) {
                    ...
                    echo '<h5 class="mb-2">Student Information</h5>
                <hr>';
            ...
            <div class="column profile">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        echo '<button type="submit" name="DeleteCourse_btn" class="close" aria-label="Close">DELETE</button>';
                        echo '</form>';
                        echo '</small>';
                        echo "</div>";

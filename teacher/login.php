...
<body>
    ...
    <div class="registration-container">
        ...
        <div class="form-section">
            ...
            ?>
            <form action="../controllers/TeacherLoginController.php" method="post">
                <label for="email">Email</label>
                <input type="email" name="email" placeholder=" Teacher Email" required autofocus>
                <label for="password">Password</label>
                <input type="password" name="password" placeholder=" Enter Password" required>
                <input type="submit" value="Login" name="login_btn" class="RegisterButton">
            </form>
            <div>
                <h6>New User? <a class="text-blue" href="register.php">Register as a Teacher</a></h6>
            </div>
        </div>
    </div>

...
<body>
    ...
    <div class="tuitions-container">
        ...
        <div class="form-section"><br>
            <h4 class="text-center">Add A Course</h4>
            <form action="../controllers/AddTeacherCourse.php" method="post">
                ...
                <input type="hidden" name="teacher_name" value="<?php echo $_SESSION['teacher']['name'] ?>">
                ...
                <div style="text-align:center;">
                    <input type="submit" value="Add" name="Add_btn" class="Add_btn">
                </div>
            </form>
        </div>
        <hr><br>
        <h3 class="text-center">Courses Offered by You</h3><br>
        <hr><br>
        <?php
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<form action="../controllers/DeleteTCourse.php" method="post">';
